  ...
  return (
    <nav className="flex items-center justify-between w-full py-4 px-2 md:px-4 h-auto bg-transparent">
      ...
      <div className="flex items-center space-x-2 md:space-x-4">
        ...
        {/* <Link
          to="/Signin"
          className="bg-logo-yellow hover:bg-logo-yellow/90 text-black text-xs sm:text-sm md:text-base 
                    font-thin px-2 py-1 md:px-4 md:py-2 rounded-lg transition-all duration-300"
        >
          Sign In
        </Link> */}
      </div>
